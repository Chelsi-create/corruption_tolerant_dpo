...
poisoning_percentages = [5.0]  # Adjust as needed
...
for percentage in poisoning_percentages:
    ...
    output_dir = f"../output/poison/sft_results/lora2/sft_results_{percentage}/"  # Directory where the model will be saved
