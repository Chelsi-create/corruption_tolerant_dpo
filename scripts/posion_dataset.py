...
def main():
    ...
    # Load the datasets
    train_data_load = load_from_disk(config['poisoning']['train_dir'])
    eval_data_load = load_from_disk(config['poisoning']['eval_dir'])
    
    # Get the parameters from the config file
    train_dataset = train_data_load
    eval_dataset = eval_data_load
