...
wandb.init(project="poison_dpo_lora2_4")  # Initialize your W&B project
...
base_output_dir = "../output/poison_only_dpo_test/lora2/dpo_results_"  # Base directory where the DPO results will be saved
